...
public class DifferenciateAlphaAndSplChar {
public static void main(String[] args) {
	...
	System.out.println("Alpha array element : ");
	for(int i=0; i < alphaArray.length; i++) {
		System.out.print(alphaArray[i]);
	}
	System.out.println();

	System.out.println("specChar array element : ");
	for(int i=0; i < specCharArray.length; i++) {
		System.out.print(specCharArray[i]);
